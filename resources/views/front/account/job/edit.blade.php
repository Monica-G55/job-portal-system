                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select" name="jobtype" id="jobtype">
                                    <option value="">Select a JobTypes</option>
                       ...
                       <p></p>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="experience" id="experience" class="form-control">
                                ...
                                <option value="6m"{{($job->experience =='6m')?'selected':''}}>6 month</option>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-md-6">
                                ...
                                <input type="text" placeholder="Location" id="location" name="company_location" class="form-control"value="{{$job->location}}">
                            </div>
                        <p></p>
                        </div>
