        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card border-0 shadow mb-4">
                    <form action="{{ route('account.updateProfile') }}" id="userForm" name="userForm" method="post">
                        @csrf
                        @method('PUT')
                    <div class="card-body  p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="email" name="email" value="{{$user->email}}" placeholder="Enter Email" class="form-control">
                        <p></p>
                        </div>
                        <div class="mb-4">
